"""Interfaz de linea de comandos.
    ...
    python -m tradingbot spread --book usdt_ars
    python -m tradingbot collect --book usdt_ars
    python -m tradingbot backtest --book usdt_ars --tf 1h --fast 10 --slow 30
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--book", default=None, help="par de mercado, ej. usdt_ars")
